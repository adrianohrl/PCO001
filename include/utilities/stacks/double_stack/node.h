...
template <typename Element> Node<Element>::Node() { previous_ = -100; }

template <typename Element>
Node<Element>::Node(Element element, int previous)
    : element_(element)
{
  previous_ = previous;
}
...
template <typename Element>
void Node<Element>::set(Element element, int previous)
{
  element_ = element;
  previous_ = previous;
}
