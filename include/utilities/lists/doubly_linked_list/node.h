...
Node<Element>::Node(Element element, Node<Element>* previous,
                    Node<Element>* next)
    : element_(element)
{
  previous_ = previous;
...
template <typename Element>
Node<Element>::Node(const Node<Element>& node)
...
template <typename Element>
void Node<Element>::setPrevious(Node<Element>* previous)
{
  previous_ = previous;
}
...
template <typename Element> bool Node<Element>::hasNext() { return next_; }
