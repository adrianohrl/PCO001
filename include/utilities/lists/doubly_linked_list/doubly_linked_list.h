...
class DoublyLinkedList : public DoublyLinkedListInterface<Element>
{
public:
  DoublyLinkedList();
...
template <typename Element>
DoublyLinkedList<Element>::DoublyLinkedList()
    : first_(NULL), last_(NULL)
{
}

template <typename Element>
DoublyLinkedList<Element>::DoublyLinkedList(const DoublyLinkedList& list)
    : first_(NULL), last_(NULL)
{
  if (list.first_)
  {
...
template <typename Element>
bool DoublyLinkedList<Element>::insert(Element element, bool from_beginning)
{
  if (isEmpty())
  {
...
template <typename Element>
bool DoublyLinkedList<Element>::remove(Element element, bool from_beginning)
{
  if (isEmpty())
  {
    return false;
...
template <typename Element>
Element DoublyLinkedList<Element>::find(Element element, bool from_beginning)
{
  if (isEmpty())
  {
    return element;
...
template <typename Element>
bool DoublyLinkedList<Element>::contains(Element element, bool from_beginning)
{
  if (isEmpty())
  {
    return false;
...
template <typename Element>
std::string DoublyLinkedList<Element>::toString(bool from_beginning)
{
  std::string str = "(";
  Node<Element>* node;
  if (!isEmpty())
