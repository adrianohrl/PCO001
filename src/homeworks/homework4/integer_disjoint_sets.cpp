...
IntegerDisjointSets::IntegerDisjointSets(std::string expression_A,
...
IntegerDisjointSets::IntegerDisjointSets(const IntegerDisjointSets& sets)
{
  ...
  {
    set_A_ =
        new utilities::lists::disjoint_set::IntegerDisjointSet(*sets.set_A_);
  }
  if (sets.set_B_)
  {
    set_B_ =
        new utilities::lists::disjoint_set::IntegerDisjointSet(*sets.set_B_);
  }
}
...
bool IntegerDisjointSets::insert(IntegerDisjointSetEnum set,
                                 std::string expression)
{
  if (set == sets::A)
  {
    return set_A_->insert(expression.c_str());
  }
  return set_B_->insert(expression.c_str());
}
...
bool IntegerDisjointSets::remove(IntegerDisjointSetEnum set,
                                 std::string expression)
{
  if (set == sets::A)
  {
    return set_A_->remove(expression.c_str());
  }
  return set_B_->remove(expression.c_str());
}
...
bool IntegerDisjointSets::find(IntegerDisjointSetEnum set,
                               std::string expression)
{
  if (set == sets::A)
  {
    return set_A_->find(expression.c_str());
  }
  return set_B_->find(expression.c_str());
}
...
bool IntegerDisjointSets::compareDisjointSets() { return set_A_ == set_B_; }
...
{
  utilities::lists::disjoint_set::IntegerExpressionParser parser;
  if (!parser.evaluate(expression.c_str()))
  {
    return false;
  }
  if (set_A_)
  ...
  set_A_ = new utilities::lists::disjoint_set::IntegerDisjointSet(expression);
}
...
bool IntegerDisjointSets::setDisjointSetB(std::string expression)
{
  ...
  set_B_ = new utilities::lists::disjoint_set::IntegerDisjointSet(expression);
}

std::ostream& operator<<(std::ostream& os, const IntegerDisjointSets& sets)
{
  os << "A = " << sets.toString(sets::A)
     << " and B = " << sets.toString(sets::B);
  return os;
}
